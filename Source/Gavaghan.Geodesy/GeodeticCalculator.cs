...
namespace Gavaghan.Geodesy
{
    ...
    public sealed class GeodeticCalculator
    {
        ...
        /// <returns></returns>
        public GlobalCoordinates CalculateEndingGlobalCoordinates(Ellipsoid ellipsoid, GlobalCoordinates start, Angle startBearing, double distanceMeters)
        {
            Angle _;
            return CalculateEndingGlobalCoordinates(ellipsoid, start, startBearing, distanceMeters, StandardTolerance, out _);
        }
